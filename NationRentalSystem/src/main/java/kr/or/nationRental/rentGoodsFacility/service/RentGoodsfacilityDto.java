...
public class RentGoodsfacilityDto {
	...
	public String toString() {
		return "RentGoodsfacilityDto [goodsfacilityRentalCode=" + goodsfacilityRentalCode + ", adminagencyCode="
				...
				+ ", goodsfacilityPriceRental=" + goodsfacilityPriceRental + ", getGoodsfacilityRentalCode()="
				+ getGoodsfacilityRentalCode() + ", getAdminagencyCode()=" + getAdminagencyCode()
				+ ", getGoodsfacilityCode()=" + getGoodsfacilityCode() + ", getGoodsfacilityName()="
				+ getGoodsfacilityName() + ", getCitizenId()=" + getCitizenId() + ", getCitizenName()="
				+ getCitizenName() + ", getCitizenPhone()=" + getCitizenPhone() + ", getGoodsfacilityRentalDateStart()="
				+ getGoodsfacilityRentalDateStart() + ", getGoodsfacilityRentalDayEnd()="
				+ getGoodsfacilityRentalDayEnd() + ", getGoodsfacilityRentalIsOrderedDelivery()="
				+ getGoodsfacilityRentalIsOrderedDelivery() + ", getGoodsfacilityRentalDateRegistration()="
				+ getGoodsfacilityRentalDateRegistration() + ", getGoodsfacilityRentalIsCanceled()="
				+ getGoodsfacilityRentalIsCanceled() + ", getGoodsfacilityRentalDeposit()="
				+ getGoodsfacilityRentalDeposit() + ", getGoodsfacilityPriceRental()=" + getGoodsfacilityPriceRental()
