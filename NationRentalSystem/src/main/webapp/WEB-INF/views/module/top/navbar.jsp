							...
							<c:when test="${member.memberLevel == '관리자'}">
						        ...
						        <div style="padding:0;" class="collapse navbar-collapse" id="bs-example-navbar-collapse-2">
						         <ul class="nav navbar-nav">
						          ...
						          <li class="backgroundColor"><a style="color:#FFFFFF" href="${pageContext.request.contextPath}/updateAdministrator?adminId=${member.memberId}">내 정보수정</a></li>
							...
							<c:when test="${member.memberLevel == '시민'}"> 
								...
								<div style="padding:0;" class="collapse navbar-collapse" id="bs-example-navbar-collapse-2">
									<ul class="nav navbar-nav">
										...
										<li class="backgroundColor"><a style="color:#FFFFFF" href="#">기부신청</a></li>
