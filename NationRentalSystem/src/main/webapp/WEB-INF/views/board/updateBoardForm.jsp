				...
				<div class="col-sm-8">
					...
					<div class="panel panel-default">
						<div class="panel-body">
							<form id="insertForm" class="form-horizontal" action="${pageContext.request.contextPath}/updateBoard" method="post">
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" class="form-control" name="boardName" id="boardName" value="${boardDto.boardName}" placeholder="글 제목">
									</div>
								</div>
								<div class="form-group">
									<label for="textBoardContent" class="col-sm-3 control-label">글 내용</label>
									<div class="col-sm-9">
										<input type="text" class="form-control" name="textBoardContent" id="textBoardContent" value="${boardDto.textBoardContent}" placeholder="글 내용">
									</div>
								</div>
								<div class="form-group hidden">
								...
								<div class="text-center">
									<button id="boardUpdateBtn" type="submit" class="btn btn-primary">수정 완료</button>
								</div>
