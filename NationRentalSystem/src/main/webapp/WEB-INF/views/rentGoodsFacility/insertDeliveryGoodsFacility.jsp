							...
							<div class="panel-body text-center">
								<form id="insertDistrict" class="form-horizontal" action="${pageContext.request.contextPath}/insertDeliverGoods" method="post">
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" class="form-control" name="goodsfacilityRentalCode" id="goodsfacilityRentalCode" value="${updateDeliveryGoods.goodsfacilityRentalCode}">
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										<label for="goodsfacilityCode" class="col-sm-3 control-label">신청인 이름</label>
										<div class="col-sm-9">
											<input type="text" class="form-control" name="goodsfacilityCode" id="goodsfacilityCode" value="${updateDeliveryGoods.citizenName}">
										</div>
									</div>									
									<div class="form-group">
